...
export const navItems = [
  { key: 'lines',     title: '라인 별 가동 현황', href: paths.dashboard.lines,        icon: 'chart-pie' },
  { key: 'downtime',  title: '비가동 일지',       href: paths.dashboard.downtime,     icon: 'clock' },
  { key: 'maint',     title: '수리 이력',         href: paths.dashboard.maintenance,  icon: 'wrench' },
  { key: 'spare',     title: '스페어 현황',       href: paths.dashboard.spare,        icon: 'package' },
